          ...
          {slides.map((s) => (
            <div className="embla__slide">
              <div className="embla__slide__number">
                <Card className="bg-custom-testimonial-card-bg shadow-sm border-[1.419px] border-solid border-custom-testimonial-card-border p-[20px]">
                  <CardContent className="p-0 flex flex-col gap-3">
                    ...
                    <div className="flex gap-1 items-center">
                      <Avatar>
                        <AvatarImage className="object-fit" src={s.img} />
